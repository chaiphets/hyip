		...
		<div class="panel panel-default">
			...
			<div class="panel-body" id="support-form">
				...
				<div class="col-xs-12 col-sm-8 col-md-8">
					<input class="form-control" type="text" name="name" required maxlength="32" />
				</div>
				<div class="col-xs-12 col-sm-3 col-md-3">Your Email:</div>
				<div class="col-xs-12 col-sm-8 col-md-8">
					<input class="form-control" type="text" name="email" required maxlength="64" />
				</div>
