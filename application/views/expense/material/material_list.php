...
<div class="row">
	<div class="col-xs-12 col-md-12">
		<button class="btn btn-info" onclick="javascript:window.location='<?=site_url('expense/material/addMaterial') ?>'">Add new material</button>
	</div>
</div>
<br>
			...
			<tbody>
				<?php foreach($materials as $key => $material):?>
					<tr class="mix <?=$material['first_name']?> <?=$material['status']?> <?=($material['is_claimed']==0)?'NotClaim':'Claimed'?>" data-materialid="<?=$material['material_id'] ?>">
						...
						<td>
							<!--a href="javascript:window.location='<?=site_url('expense/material/showMaterial/') . '/' . $material['material_id'] ?>'"><?=$material['material_name'] ?></a-->
							<a href="<?=site_url('expense/material/showMaterial/'.$material['material_id'])?>"><?=$material['material_name']?></a>
						</td>
