...
<?php if(!isset($readonly)):?>
<?=form_open('expense/misc/saveMaterial', array('id'=>'saveForm','class'=>'form-horizontal','role'=>'form'))?>
<?php else:?>
...
<?php endif;?>
	<div class="form-group">
		...
		<div class="col-md-6">
			<input class="form-control" type="text" name="material_name" id="material_name" value="<?=$material['material_name']?>" placeholder="จิปาถะ" maxlength="128" required />
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-xs-5 col-md-2">
			<input class="form-control decimal" type="text" name="claim_rate" id="claim_rate" value="<?=$material['claim_rate']?>" placeholder="เปอร์เซ็นการเบิก" required />
		</div>
	</div>
	<div class="form-group">
